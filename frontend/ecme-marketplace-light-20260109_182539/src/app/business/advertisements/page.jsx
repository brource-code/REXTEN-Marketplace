                ...
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                Управление вашими объявлениями на маркетплейсе
                            </p>
                        </div>
                    ...
                    {advertisements.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <h4 className="text-lg font-semibold mb-2">Нет объявлений</h4>
                            <p className="text-sm text-gray-500 mb-4">
                                Создайте первое объявление для продвижения вашего бизнеса
                            </p>
                            {error && (
                ...
                {selectedAd && (
                    <div className="flex flex-col h-full max-h-[85vh]">
                        <div className="px-6 pt-6 pb-4 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
                            <h4 className="text-lg">Просмотр объявления</h4>
                        </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                                    ...
                                    {selectedAd.placement && (
                                        <div>
                                            ...
                                            <div className="font-semibold">{selectedAd.placement}</div>
                                        </div>
                                    )}
                                    {selectedAd.city && (
                                        <div>
                                    ...
                                    {selectedAd.price_from && (
                                        <div>
                                            ...
                                            <div className="font-semibold">{selectedAd.price_from} {selectedAd.currency || 'USD'}</div>
                                        </div>
                                    )}
                                    {selectedAd.price_to && (
                                        <div>
                                            <div className="text-xs text-gray-500 mb-1">Цена до</div>
                                            <div className="font-semibold">{selectedAd.price_to} {selectedAd.currency || 'USD'}</div>
                                        </div>
                                    )}
                                    {selectedAd.link && (
                                    ...
                                    {selectedAd.created_at && (
                                        <div>
                                            ...
                                            <div className="font-semibold text-sm">
                                                {new Date(selectedAd.created_at).toLocaleDateString('ru-RU')}
                                            </div>
                                        </div>
                                    )}
                                    {selectedAd.updated_at && (
                                        <div>
                                            <div className="text-xs text-gray-500 mb-1">Дата обновления</div>
                                            <div className="font-semibold text-sm">
                                                {new Date(selectedAd.updated_at).toLocaleDateString('ru-RU')}
                                            </div>
                                        </div>
                                    )}
                                </div>
