...
export default function ClientBookingPage() {
    ...
    // Форматирование даты (без учета таймзоны)
                    ...
                    <Card className="mb-4">
                        <div className="p-3 sm:p-4">
                            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                                Здесь вы видите все свои записи к мастерам. Вы можете отменить предстоящее бронирование не позднее, чем за 24 часа до начала.
                            </p>
                        </div>
                    </Card>
                            ...
                            <div className="p-4 sm:p-6">
                                <div className="mb-4">
                                    <h4 className="text-lg font-semibold text-gray-900 dark:text-white">
                                        Календарь ваших бронирований
                                    </h4>
                                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                        Ближайшие записи выделены цветом
                                    </p>
                                </div>
                                            ...
                                            <div className="flex-1 space-y-3">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {booking.total_price && booking.total_price !== booking.price && (
                                                            <span className="text-xs text-gray-500 dark:text-gray-400">
                                                                (базовая: {formatPrice(booking.price)})
                                                            </span>
                                                        )}
                                                    </div>
                                                </div>
                                                                        ...
                                                                        <div className="flex-1">
                                                                            ...
                                                                            {quantity > 1 && (
                                                                                <div className="text-xs text-gray-500 dark:text-gray-500 mt-0.5">
                                                                                    Количество: {quantity} × {formatPrice(price)}
                                                                                </div>
                                                                            )}
                                                                        </div>
                                                ...
                                                {booking.notes && (
                                                    <div className="text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800/50 rounded-lg p-3 border border-gray-100 dark:border-gray-700 mt-3">
                                                        <span className="font-medium text-gray-700 dark:text-gray-300">Примечания:</span>{' '}
