...
import { PiEye, PiCursorClick, PiGear, PiCheck, PiX, PiTrash, PiPencil, PiPlus, PiDotsThreeVertical, PiArrowRight } from 'react-icons/pi'
...
const ActionColumn = ({ row, onApprove, onReject, onEdit, onDelete, onPlacement, onToggleActive, approveLoading, rejectLoading, type = 'advertisement' }) => {
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            {ad.type === 'advertisement' && (ad.start_date || ad.end_date) && (
                                <div className="text-xs text-gray-500 mb-1">
                                    {ad.start_date ? new Date(ad.start_date).toLocaleDateString('ru-RU') : '-'} - {ad.end_date ? new Date(ad.end_date).toLocaleDateString('ru-RU') : '-'}
                                </div>
                            )}
                        </div>
