...
export const ServicesHomeScreen: React.FC = () => {
  ...
  const dynamicStyles = {
    ...
    featuredTitle: { fontSize: 20, fontWeight: '600' as const, color: colors.text },
    featuredBadge: {
    ...
    featuredBadgeText: { fontSize: 11, color: colors.textSecondary, fontWeight: '500' as const },
    listHeader: {
      paddingHorizontal: 16,
      paddingTop: 24,
      paddingBottom: 12,
    ...
    listHeaderText: { fontSize: 15, color: colors.textSecondary },
    listHeaderCount: { fontWeight: '600' as const, color: colors.text },
  };
          ...
          ListHeaderComponent={
            <>
              ...
              {featuredServices.length > 0 && (
                <View style={dynamicStyles.featuredSection}>
                  <View style={styles.featuredHeader}>
                    <Text style={dynamicStyles.featuredTitle}>Рекомендуемые</Text>
                    <View style={dynamicStyles.featuredBadge}>
                      <Text style={dynamicStyles.featuredBadgeText}>Реклама</Text>
                    </View>
                  </View>
              ...
              <View style={dynamicStyles.listHeader}>
                <Text style={dynamicStyles.listHeaderText}>
                  Найдено <Text style={dynamicStyles.listHeaderCount}>{filteredListings.length}</Text> предложений
                </Text>
              </View>
            </>
          }
