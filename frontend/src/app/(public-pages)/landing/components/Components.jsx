                ...
                <div className="grid grid-cols-1 lg:grid-cols-8 gap-4">
                    ...
                    >
                        <motion.h2 className="mb-8 max-w-[650px] leading-[1.3] text-5xl">
                            Готовые блоки для витрин и бронирований
                        </motion.h2>
                        <motion.p className="max-w-[600px]">
                            Формы записи, карточки услуг, таблицы клиентов и
                            фильтры уже реализованы на Tailwind. Просто
                            комбинируйте блоки REXTEN, чтобы собрать страницу
                            мастера или каталог.
                        </motion.p>
                    </motion.div>
