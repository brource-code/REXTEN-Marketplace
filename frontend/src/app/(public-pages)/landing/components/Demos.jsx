        ...
        <div id="demos" className="relative z-20 py-10 md:py-40">
            ...
            >
                <motion.h2 className="my-6 text-5xl">
                    Примеры витрин бизнеса на REXTEN
                </motion.h2>
                <motion.p className="mx-auto max-w-[600px]">
                    Посмотрите, как выглядят страницы услуг, созданные на нашей платформе.
                    Всё это работает автоматически, поддерживает онлайн-оплату и не требует дизайнера.
                </motion.p>
            </motion.div>
            <Container>
