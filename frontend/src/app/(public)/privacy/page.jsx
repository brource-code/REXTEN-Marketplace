                    ...
                    <div className="prose prose-gray dark:prose-invert max-w-none space-y-6 text-gray-700 dark:text-gray-300">
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>{t('section2.subsection1.list.item4')}</li>
                            </ul>
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>{t('section2.subsection2.list.item4')}</li>
                                <li>{t('section2.subsection2.list.item5')}</li>
                            </ul>
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>{t('section2.subsection3.list.item4')}</li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>{t('section3.list.item6')}</li>
                                <li>{t('section3.list.item7')}</li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <p>{t('section4.subsection1.content')}</p>
                            <ul className="list-disc pl-6 space-y-2">
                                <li>{t('section4.subsection1.list.item1')}</li>
                                <li>{t('section4.subsection1.list.item2')}</li>
                                <li>{t('section4.subsection1.list.item3')}</li>
                            </ul>
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">
                                {t('section4.subsection2.title')}
                            </h3>
                            <p>{t('section4.subsection2.content')}</p>
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">
                                {t('section4.subsection3.title')}
                            </h3>
                            <p>{t('section4.subsection3.content')}</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>{t('section6.subsection1.content')}</p>
                            <ul className="list-disc pl-6 space-y-2">
                                <li>{t('section6.subsection1.list.item1')}</li>
                                <li>{t('section6.subsection1.list.item2')}</li>
                                <li>{t('section6.subsection1.list.item3')}</li>
                                <li>{t('section6.subsection1.list.item4')}</li>
                                <li>{t('section6.subsection1.list.item5')}</li>
                                <li>{t('section6.subsection1.list.item6')}</li>
                            </ul>
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">
                                {t('section6.subsection2.title')}
                            </h3>
                            <p>{t('section6.subsection2.content')}</p>
                            <ul className="list-disc pl-6 space-y-2">
                                <li>{t('section6.subsection2.list.item1')}</li>
                                <li>{t('section6.subsection2.list.item2')}</li>
                                <li>{t('section6.subsection2.list.item3')}</li>
                                <li>{t('section6.subsection2.list.item4')}</li>
                                <li>{t('section6.subsection2.list.item5')}</li>
                            </ul>
                            <p className="mt-4">{t('section6.subsection2.note')}</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mt-4">{t('section11.note')}</p>
                        </section>
                    </div>
                </div>
            </Container>
