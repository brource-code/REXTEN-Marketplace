...
export default function CompanyProfileClient({
    initialProfile = null,
    initialSlug = null,
    companyTitleAsH2 = false,
}) {
    const TitleTag = companyTitleAsH2 ? 'h2' : 'h1'
    ...
    const { data: profile, isLoading, error } = useQuery({
        ...
        enabled: !!slug,
        initialData:
            initialProfile != null && marketplaceSlugsMatch(slug, initialSlug)
                ? initialProfile
                : undefined,
        staleTime:
            initialProfile != null && marketplaceSlugsMatch(slug, initialSlug)
    ...
    return (
        <>
            ...
            <Container className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* ========== HERO БЛОК ========== */}
                <div className="mb-8">
                    <TitleTag className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-2">
                        {company.name}
                    </TitleTag>
