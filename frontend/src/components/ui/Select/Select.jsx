...
/** Не открывает клавиатуру на мобильных: выбор из списка, а не ввод текста */
const ReadOnlySelectInput = (props) => (
    ...
    return (
        <Component
            ...
            components={{
                ...
                ...(!isSearchable && !components?.Input ? { Input: ReadOnlySelectInput } : {}),
                ...components,
            }}
            {...field}
            {...rest}
