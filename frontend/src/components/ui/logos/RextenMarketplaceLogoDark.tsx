...
export default function RextenMarketplaceLogoDark(
  ...
  const { customText = 'REXTEN', customColor = '#FFFFFF', customSize = 26, customIconColor = REXTEN_MARK_COLOR, ...svgProps } = props
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        <linearGradient id={`logo-dark-gradient2-${gradientId}`} x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <linearGradient id={`logo-dark-gradient3-${gradientId}`} x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <path d="M4 8L15 2L26 8L15 14L4 8Z" id="logo-dark-layer-1" />
        <path d="M4 14L15 8L26 14L15 20L4 14Z" id="logo-dark-layer-2" />
        <path d="M4 20L15 14L26 20L15 26L4 20Z" id="logo-dark-layer-3" />
      </defs>
      <g id="logo-icon-dark" transform="translate(12, 12) scale(0.9)">
        <g id="Layer-1">
          <use fill={`url(#logo-dark-gradient1-${gradientId})`} xlinkHref="#logo-dark-layer-1" />
          <use fillOpacity="0.3" fill="#FFFFFF" xlinkHref="#logo-dark-layer-1" />
        </g>
        <g id="Layer-2" transform="translate(1, 2)">
          <use fill={`url(#logo-dark-gradient2-${gradientId})`} xlinkHref="#logo-dark-layer-2" />
          <use fillOpacity="0.2" fill="#FFFFFF" xlinkHref="#logo-dark-layer-2" />
        </g>
        <g id="Layer-3" transform="translate(2, 4)">
          <use fill={`url(#logo-dark-gradient3-${gradientId})`} xlinkHref="#logo-dark-layer-3" />
          <use fillOpacity="0.1" fill="#FFFFFF" xlinkHref="#logo-dark-layer-3" />
        </g>
      </g>
      {customText && (
        <text
