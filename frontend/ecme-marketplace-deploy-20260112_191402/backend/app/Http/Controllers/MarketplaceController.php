    ...
    public function getServiceProfile($slug)
    {
        ...
        if ($advertisement) {
            ...
            $adReviews = Review::where(function($q) use ($advertisement) {
                ...
                ->where('is_visible', true)
                ->with(['service', 'booking.specialist.profile', 'order.booking.specialist.profile', 'booking'])
                ->get()
        ...
        $serviceReviews = $service->reviews()->where('is_visible', true)->with(['user' => function($query) {
            $query->with('profile');
        }, 'service', 'booking.specialist.profile', 'order.booking.specialist.profile', 'booking'])->get();
        ...
        $companyReviews = Review::where('company_id', $company->id)
            ...
            ->with(['user' => function($query) {
                $query->with('profile');
            }, 'service', 'booking.specialist.profile', 'order.booking.specialist.profile', 'booking'])
            ->get();
