        ...
        >
            ...
            >
                <div className={classNames(
                    ...
                    sideNavCollapse && 'ltr:ml-[11.5px] ltr:mr-[11.5px] justify-center',
                    !sideNavCollapse && classNames(LOGO_X_GUTTER, 'ltr:pl-4 rtl:pr-4')
                )}>
                    <Logo
                        imgClass={sideNavCollapse ? "max-h-10" : "max-h-14"}
                        mode={mode || defaultMode}
                        type="full"
                        customText={sideNavCollapse ? '' : undefined}
                        forceSvg={true}
