...
const priceRanges = [
    ...
    { id: 'lt75', label: 'до $75', max: 75 },
    { id: '75-125', label: '$75 – $125', min: 75, max: 125 },
    { id: 'gt125', label: 'от $125', min: 125 },
]
        ...
        <div className="p-4 space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <div className="space-y-1 min-h-[440px]">
                        ...
                        {hiddenCount > 0 && (
                            ...
                            >
                                {showAllCategories ? 'Свернуть' : `Показать ещё ${hiddenCount} категорий`}
                            </button>
                        )}
                    </div>
                </div>
                ...
                <div className="space-y-3">
                            ...
                            <Select
                                ...
                                onChange={(option) => {
                                    ...
                                    if (option === null) {
                                        ...
                                        else if (option.label && option.label !== 'Все города') {
                    ...
                    <div>
                        ...
                        <Select
                            ...
                            placeholder="Любой бюджет"
                            options={priceRanges.map((range) => ({
                                value: range.id,
                                label: range.label,
                            }))}
                            value={priceRanges.find((r) => r.id === priceFilter) ? {
                                value: priceFilter,
                                label: priceRanges.find((r) => r.id === priceFilter)?.label || '',
                            } : null}
                    ...
                    <div>
                        ...
                        <Select
                            ...
                            value={ratingFilter ? {
                                ...
                                label: ratingOptions.find((r) => r.id === ratingFilter)?.label || '',
                            } : { value: '', label: 'Любой' }}
            ...
            <div className="pt-3 border-t border-gray-200 dark:border-gray-700 space-y-2">
                <p className="text-xs text-gray-600 dark:text-gray-400 text-center">
                    Найдено: <strong className="text-gray-900 dark:text-white">{resultCount}</strong>
                </p>
                <Button
                    variant="plain"
                    size="sm"
...
export default function ServicesPage() {
    ...
    const formatListing = (service) => {
        const baseCategory = categories.find((cat) => cat.id === service.group)?.name ?? service.category ?? 'Услуга'
        ...
        if (rawImageUrl && !rawImageUrl.includes('placeholder')) {
            if (isAdvertisement) {
                // Для объявлений бэкенд уже вернул полный URL, используем как есть
                // Но если это относительный путь, все равно нормализуем (на случай если бэкенд не нормализовал)
                ...
                // Для обычных услуг нормализуем только относительные пути
                imageUrl = normalizeImageUrl(rawImageUrl)
            }
        } else {
            imageUrl = null
    ...
    return (
        <main className="px-4 lg:px-0 text-base bg-white dark:bg-gray-900 overflow-x-hidden pt-20 md:pt-24 [overflow-anchor:none]">
            ...
            <section className="relative overflow-hidden pt-6 pb-6 md:pt-8 md:pb-10 lg:pb-12 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-900">
                <div
                    ...
                    <div className="grid gap-4 md:gap-6 lg:grid-cols-12">
                        <div className="lg:col-span-12 lg:col-start-1">
                            <div className="text-left space-y-3 md:space-y-4">
                                ...
                                <h1 className="text-xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 dark:text-white leading-tight">
                                    Найдите{' '}
                                ...
                                <motion.p
                                    ...
                                    className="text-xs md:text-base lg:text-lg text-gray-600 dark:text-gray-300 leading-relaxed line-clamp-2 md:line-clamp-none"
                                >
                                    Все услуги в одном месте: бронирование, рейтинг,
                                    отзывы.
                                </motion.p>
                                ...
                                <div className="flex flex-wrap items-center gap-3 sm:gap-4 md:gap-6 pt-2">
                                    <div className="flex items-center gap-2 text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300">
                                        ...
                                        <span className="font-semibold whitespace-nowrap">10 000+ бронирований</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300">
                                        ...
                                        <span className="font-semibold whitespace-nowrap">500+ мастеров</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300">
                                        ...
                                        <span className="font-semibold whitespace-nowrap">4.9★ рейтинг</span>
                                    </div>
                                </div>
                            ...
                            <div ref={listingsRef}>
                                ...
                                <div className="mb-4">
                                    <div className="flex flex-wrap items-center gap-2 sm:gap-2.5 md:gap-3 mb-3">
                                        ...
                                        >
                                            <span className="hidden sm:inline">Со свободными слотами</span>
                                            <span className="sm:hidden">Свободные слоты</span>
                                        </button>
                                        <button
                                        ...
                                        >
                                            <span className="hidden sm:inline">Сейчас открыто</span>
                                            <span className="sm:hidden">Открыто</span>
                                        </button>
                                    </div>
                                        ...
                                        <>
                                            ...
                                            {filteredListings.length > visibleServicesCount && (
                                                <div className="mt-6 text-center">
                                                    ...
                                                    >
                                                        Показать ещё ({filteredListings.length - visibleServicesCount} осталось)
                                                    </Button>
                                                </div>
                                            )}
                                        </>
