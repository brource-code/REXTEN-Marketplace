...
import { PiPhone, PiEnvelope, PiCalendar, PiClock, PiNote, PiArrowLeft, PiUser, PiCheckCircle, PiXCircle, PiMapPin } from 'react-icons/pi'
                                                                ...
                                                                <div className="flex-1">
                                                                    ...
                                                                    {(booking.execution_type || 'onsite') === 'offsite' && (
                                                                        <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                                                            Тип исполнения: Выезд к клиенту
                                                                        </div>
                                                                    )}
                                                                </div>
                                                            ...
                                                            {(booking.execution_type || 'onsite') === 'offsite' && booking.location && (
                                                                <div className="mt-2 pt-2 border-t border-gray-100 dark:border-gray-700">
                                                                    <div className="text-sm">
                                                                        <div className="font-medium text-gray-700 dark:text-gray-300 mb-1">Адрес:</div>
