                    ...
                    <form onSubmit={handleSubmit} className="space-y-6" id="schedule-slot-form">
                        ...
                        {slot?.type === 'EDIT' && (
                            <div className="space-y-5 pb-6 border-b border-gray-200 dark:border-gray-700">
                                ...
                                {slot.execution_type === 'offsite' && slot.location && (
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="text-sm text-gray-900 dark:text-white space-y-1">
                                                {slot.location.address_line1 && (
                                                    <div className="font-medium">{slot.location.address_line1}</div>
                                                )}
                                                {(slot.location.city || slot.location.state || slot.location.zip) && (
                                                    <div className="text-gray-600 dark:text-gray-400">
                                                        {[slot.location.city, slot.location.state, slot.location.zip].filter(Boolean).join(', ')}
                                                    </div>
                                                )}
                                                {slot.location.notes && (
