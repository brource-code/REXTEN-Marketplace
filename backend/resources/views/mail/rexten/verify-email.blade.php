...
<head>
    ...
    <title>{{ __('mail.verify_email.subject', ['app' => $appName], $locale) }}</title>
    <style type="text/css">
...
<body class="rexten-email-outer" style="margin:0;padding:0;background-color:#f3f4f6;-webkit-font-smoothing:antialiased;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">
        {{ __('mail.verify_email.preheader', ['app' => $appName], $locale) }}
    </div>
        ...
        <tr>
            <td align="center">
                <table role="presentation" class="rexten-email-card" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="max-width:560px;background-color:#ffffff;border-radius:12px;border:1px solid #e5e7eb;overflow:hidden;box-shadow:0 1px 2px rgba(15,23,42,0.06);">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:top;padding:0;">
                                        ...
                                        <p class="rexten-text-heading" style="margin:8px 0 0 0;font-family:Roboto,-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:18px;font-weight:700;color:#111827 !important;-webkit-text-fill-color:#111827;">
                                            {{ __('mail.verify_email.title', [], $locale) }}
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" style="padding:24px 28px 8px 28px;background-color:#ffffff;">
                            <p class="rexten-text-body" style="margin:0;font-family:Roboto,-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:14px;font-weight:600;line-height:1.6;color:#6b7280 !important;-webkit-text-fill-color:#6b7280;">
                                {{ __('mail.verify_email.intro', [], $locale) }}
                            </p>
                        </td>
                    </tr>
                    @isset($code)
                    <tr>
                        <td bgcolor="#ffffff" style="padding:8px 28px 16px 28px;background-color:#ffffff;">
                            <p class="rexten-text-body" style="margin:0 0 8px 0;font-family:Roboto,-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:14px;font-weight:600;line-height:1.6;color:#6b7280 !important;-webkit-text-fill-color:#6b7280;">
                                {{ __('mail.verify_email.code_intro', [], $locale) }}
                            </p>
                            <p class="rexten-text-heading" style="margin:0;font-family:ui-monospace,Menlo,Consolas,monospace;font-size:28px;font-weight:700;letter-spacing:0.35em;color:#111827 !important;-webkit-text-fill-color:#111827;text-align:center;">
                                {{ $code }}
                            </p>
                        </td>
                    </tr>
                    @endisset
                    <tr>
                        <td bgcolor="#ffffff" style="padding:0 28px 16px 28px;background-color:#ffffff;">
                            <p class="rexten-text-subtle" style="margin:0;font-family:Roboto,-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:12px;font-weight:600;line-height:1.5;color:#9ca3af !important;-webkit-text-fill-color:#9ca3af;word-break:break-all;">
                                {{ __('mail.verify_email.expires', ['count' => $expireMinutes], $locale) }}
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" style="padding:0 28px 24px 28px;background-color:#ffffff;">
                            <p class="rexten-text-body" style="margin:0;font-family:Roboto,-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:12px;font-weight:600;line-height:1.6;color:#6b7280 !important;-webkit-text-fill-color:#6b7280;">
                                {{ __('mail.verify_email.ignore', [], $locale) }}
                            </p>
                        </td>
                    </tr>
                    <tr>
